...
В директории `internal/domain` находятся обработчики реализованного API веб-сервера.

В директории `internal/model` находятся общие для всего приложения константы и описание общих объектов.

В директории `internal/repository` находится весь функционал работы с репозиториями: PostgreSQL, MongoDB, Redis и файловое хранилище S3.
