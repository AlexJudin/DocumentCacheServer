...
func TestGetWalletBalanceByUUIDWhenOk(t *testing.T) {
	...
	req := httptest.NewRequest("GET", "/controller/v1/wallets/?WALLET_UUID=ec82ea03-2b53-4258-ba87-a7efae979c43", nil)
...
func TestGetWalletBalanceByUUIDWhenWalletUUIDIsEmpty(t *testing.T) {
	...
	req := httptest.NewRequest("GET", "/controller/v1/wallets/?WALLET_UUID=", nil)
...
func TestGetWalletBalanceByUUIDWhenMissingWalletUUID(t *testing.T) {
	...
	req := httptest.NewRequest("GET", "/controller/v1/wallets/", nil)
...
func TestCreateOperationWhenOk(t *testing.T) {
	...
	req := httptest.NewRequest("POST", "/controller/v1/wallet", strings.NewReader(bodyJSON))
...
func TestCreateOperationWhenBodyIsEmpty(t *testing.T) {
	...
	req := httptest.NewRequest("POST", "/controller/v1/wallet", nil)
